(function () {
  ...
  const upperToolSet$k = [{type: 'btn-banner', cssModifier: 'bookmark-list',
  ...
  const upperToolSet$g = [{ type: 'banner', cssModifier: 'bookmark-folder-delete',
    text: 'Folder Delete' },];
  ...
  const upperToolSet$f = [{type: 'banner', cssModifier: 'bookmark-folder-rename',
    text: 'Folder Rename'},];
  ...
  const upperToolSet$c = [{type: 'btn-banner', cssModifier: 'search-result',
